...
export const CATEGORIES: Category[] = [
  {
    ...
    words: [
      ...
      'demo', 'stakeholder', 'prioritize', 'scope creep', 'sprint goal',
      'daily scrum', 'planning poker', 'definition of ready',
    ],
  },
  {
    id: 'corporate',
    ...
    words: [
      ...
      'helicopter view', 'granular', 'drill down', 'boil the ocean',
      'bleeding edge', 'north star', 'parking lot', 'table this',
      'unpack', 'double-click', 'socialize', 'peel back the onion',
      'ideate', 'learnings',
    ],
  },
  {
